    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl p-6 bg-white dark:bg-[#0f0f0f] border border-blue-500/30 shadow-xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-blue-500">Detalles del Servicio</h2>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-white/5 rounded-xl">
            ...
            <div>
              <p className="text-xs text-gray-500 uppercase font-bold">Nombre del Servicio</p>
              <p className="text-gray-800 dark:text-gray-200">{service.name}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-gray-50 dark:bg-white/5 rounded-xl">
              ...
              <p className="text-lg font-semibold text-green-500">{service.price}</p>
            </div>
            <div className="p-3 bg-gray-50 dark:bg-white/5 rounded-xl">
              <p className="text-xs text-gray-500 font-bold uppercase">Duración</p>
              <p className="text-gray-800 dark:text-gray-200">{service.duration}</p>
            </div>
          </div>

          {/* Datos extra que NO están en el editar */}
          <div className="p-3 border border-dashed border-gray-200 dark:border-zinc-800 rounded-xl space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-gray-400">#SERV-{service.id}</span>
            </div>
          </div>
        </div>
      </div>
