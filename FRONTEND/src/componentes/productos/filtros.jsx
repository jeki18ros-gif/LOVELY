...
const FilterBar = ({ filters, setFilters }) => {
  ...
  const selectClasses = `
    ...
    focus:ring-2 focus:ring-cyan-500/40 focus:border-cyan-500
    ...
    >
      ...
      <div className="relative flex-grow max-w-xs">
        ...
        <input
          ...
          className="w-full bg-white dark:bg-[#0f0f0f] border border-gray-200 dark:border-zinc-700 rounded-lg py-2.5 pl-10 pr-4 text-sm text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-cyan-500/40 focus:border-cyan-500 outline-none transition"
        />
      </div>
